...
ld65 -v  --dbgfile  "build\decembers_fullmoon.dbg" -t nes "build\init.o" "build\main.o" "build\ppu_manager.o" "build\entities.o" "build\pads.o" "build\bg.o" "build\player.o" "build\level.o" -o "build\decembers_fullmoon.nes" 
